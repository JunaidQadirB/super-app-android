...
public class Constants {
   ...
   public final static String PRIVACY_POLICY = "";




    public final static String TAG = "Carmarz_";
    ...
    public final static String SUPPORT_EMAIL = "support@system.com";
    public static final String PHONE_NO = "+1111111111";
