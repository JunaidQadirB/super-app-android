...
import static com.moonbear.carmarz.codeclasses.Variables.PACKAGE_URL_SCHEME;
...
import com.moonbear.carmarz.BuildConfig;
import com.moonbear.carmarz.Constants;
import com.moonbear.carmarz.Interface.Callback;
...
public class Functions {
    ...
    public static float getDPToPixels(int i) {
        return TypedValue.applyDimension(1, (float) i, Carmarz.getAppContext().getResources().getDisplayMetrics());
    }
