...
import com.moonbear.carmarz.foodadapter.AddToCartExpandable;
import com.moonbear.carmarz.Interface.FragmentCallBack;
import com.moonbear.carmarz.model.CalculationModel;
import com.moonbear.carmarz.model.ChildExpandListModel;
import com.moonbear.carmarz.model.MenuDetailsModel;
import com.moonbear.carmarz.model.ParentExpandListModel;
import com.moonbear.carmarz.model.ResturantModel;
import com.moonbear.carmarz.R;
import com.moonbear.carmarz.databinding.DateSheduleDialogFoodBinding;
import com.moonbear.carmarz.databinding.FragmentAddToCartBinding;
    ...
    private boolean checkCart(String id) {
        ...
        if (!dataList.isEmpty()) {
            for (int x = 0; x < dataList.size(); x++) {
                return !dataList.get(x).getRestID().equals(id);
            }
        } else {
            return false;
        }
