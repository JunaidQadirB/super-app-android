...
import com.moonbear.carmarz.databinding.FragmentLoginOrSignupBinding;
...
public class LoginOrSignupFragment extends RootFragment implements View.OnClickListener {
    ...
    private String countryId = Constants.defaultCountryId;
    private String countryCode = Constants.defaultCountryCode;
    private String countryIos = Constants.defaultCountryISOCode;
    private final String countryName = Constants.defaultCountryName;
    ...
    private void handleSignInResult(Task<GoogleSignInAccount> completedTask) {
        ...
        try {
            ...
            if (account != null) {
                ...
                Functions.logDMsg("params at authTokon : " + authToken);
            ...
            binding.progressGoogle.setVisibility(View.GONE);
            e.printStackTrace();
            Functions.logDMsg("exception at login : " + e);
        }
    }
