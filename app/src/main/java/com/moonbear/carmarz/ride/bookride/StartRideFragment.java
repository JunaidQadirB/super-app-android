...
import com.moonbear.carmarz.adapter.SuggestedGrabAdapter;
...
import com.moonbear.carmarz.Interface.RouteCallBack;
...
import com.moonbear.carmarz.databinding.FragmentStartRideBinding;
...
//        vehicleListForTwo
    ...
    private void callApiOfRequestVehicle() {
        ...
        try {
            ...
            e.printStackTrace();
            Functions.logDMsg("Exception at requestVehicle : " + e);
        }
