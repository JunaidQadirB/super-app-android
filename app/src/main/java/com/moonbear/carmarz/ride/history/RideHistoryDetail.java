...
import com.moonbear.carmarz.ride.activeride.RatingFragment;
import com.moonbear.carmarz.Interface.FragmentCallBack;
import com.moonbear.carmarz.model.HistoryModel;
import com.moonbear.carmarz.model.TripHistoryModel;
import com.moonbear.carmarz.R;
import com.moonbear.carmarz.databinding.FragmentRideFareBinding;
    ...
    private void setUpScreenData() {
        ...
        if (historyModel.finalFare != null && !historyModel.finalFare.equalsIgnoreCase("")) {
            ...
            if (historyModel.payCollectFromWallet != null && !historyModel.payCollectFromWallet.equalsIgnoreCase("")) {
                ...
                binding.carmarzPayLayout.setVisibility(View.GONE);
