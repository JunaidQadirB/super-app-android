...
import com.moonbear.carmarz.databinding.FragmentResetforgotPasswordBinding;
...
public class ResetForgotPasswordFragment extends RootFragment implements View.OnClickListener {
    ...
    private boolean checkInputValue() {
        ...
        return binding.etNewPassword.getText().toString().equalsIgnoreCase(binding.etConfirmPassword.getText().toString());
    }
