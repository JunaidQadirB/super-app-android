...
import com.moonbear.carmarz.databinding.FragmentEditPersonalInfoBinding;
import com.moonbear.carmarz.databinding.GenderDialogBinding;
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.dateLayout:
                Functions.hideSoftKeyboard(getActivity());
                Functions.methodOpenDateTimePicker( binding.tvDob.getText().toString(), getActivity().getSupportFragmentManager(), new com.moonbear.carmarz.Interface.Callback() {
                    @Override
