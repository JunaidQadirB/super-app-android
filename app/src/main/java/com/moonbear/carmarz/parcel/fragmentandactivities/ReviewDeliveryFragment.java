...
import com.moonbear.carmarz.Interface.CallbackResponse;
...
import com.moonbear.carmarz.parcel.adapter.DropOffAdapter;
import com.moonbear.carmarz.parcel.model.RecipientModel;
import com.moonbear.carmarz.ride.payment.PayWithBottomSheetFragment;
import com.moonbear.carmarz.ride.bookride.BookGrabCarBottomSheet;
import com.moonbear.carmarz.ride.bookride.PromoCodeFragment;
...
import com.moonbear.carmarz.databinding.DateSheduleDialogBinding;
import com.moonbear.carmarz.databinding.FragmentReviewDeliveryBinding;
import com.moonbear.carmarz.parcel.model.DeliveryMainModel;
...
public class ReviewDeliveryFragment extends RootFragment implements View.OnClickListener {
    ...
    private void dateSchedulePicker() {
        ...
        datebinding.dateText.setText(DateOperations.changeDateFormat("EEE MMM dd HH:mm:ss zzzz yyyy", "EEE MMM dd hh:mm a", "" + date));
        ...
        datebinding.buttonSelectDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String formattednow = DateOperations.changeDateFormat("EEE MMM dd HH:mm:ss zzzz yyyy", "yyyy-MM-dd HH:mm:ss", "" + now);
